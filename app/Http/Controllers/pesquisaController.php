...
class pesquisaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $pesquisa = $request->has('pesc') ? $request->input('pesc') : "0";
        ...
        return view('pesquisa', compact('nick', 'displayarquivo', 'nomearquivo', 'linkbaixar', 'identificador', 'valordapagina','total_de_dados_utilizados','porcentagem_total','porcentagem_grafica'));
    ...
    public function publico(Request $request)
    {
        ...
        $nick = $request->has('nick') ? $request->input('nick') : "0";
        ...
        foreach ($dados as $dado) {
            ...
            return view('pesquisapublica', compact('nick', 'displayarquivo', 'nomearquivo', 'linkbaixar', 'identificador', 'valordapagina'));

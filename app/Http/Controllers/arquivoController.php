...
class arquivoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dados = dados::where('nick', $nick)->pluck('nome')->toArray();
        ...
        return view('arquivos', compact('nick', 'displayarquivo', 'nomearquivo', 'linkbaixar', 'identificador', 'valordapagina','total_de_dados_utilizados','porcentagem_total','porcentagem_grafica'));

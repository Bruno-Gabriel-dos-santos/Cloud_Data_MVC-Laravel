...
@section('content')
        ...
        <div class="menuprincipal" id="menuprinc">
            ...
            <li id="esp">
                ...
                <a href="fotos" style="color:white;text-decoration:none ;">         <ul class="select"><p class="p3"> Fotos </p>             </ul></a>
    ...
    @endfor
        ...
        <form style="display:inline;" action="fotos" method="post">
        @csrf
        <button class="botpasspagina" type="submit" name="bot0" value="bot0"> Pagina anterior</button>
        </form><form style="display:inline;" action="fotos" method="post">
        @csrf

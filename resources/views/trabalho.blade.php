...
<div class="container-10">
            <li id="esp">
                ...
                <a href="trabalho"  style="color:white;text-decoration:none ;">     <ul class="select"><p class="p3"> Trabalho </p>          </ul></a>
    ...
    @endfor
        ...
        <form style="display:inline;" action="trabalho" method="post">
        @csrf
        <button class="botpasspagina" type="submit" name="bot0" value="bot0"> Pagina anterior</button>
        </form><form style="display:inline;" action="trabalho" method="post">
        @csrf
